...
const CourseProgress = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto p-4">
      {/* Course Title and Mark as Completed Button */}
      ...
      {/* Show Download Certificate Button Only if Completed */}
      {completed && (
        <div className="flex justify-end mb-4">
          <Button
            onClick={() => navigate("/certificate")} // ⬅️ Use navigate to go to the certificate page
